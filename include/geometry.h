 ...
 *
 * @param lines A constant reference to a vector of Vec3f representing the lines.
 * @param out_intersections A reference to a vector of Points where the intersection points will be stored.
 * @param rows The number of rows in the grid (height of the area to compute intersections).
 * @param cols The number of columns in the grid (width of the area to compute intersections).
 */
 ...
 *
 * @param lines A constant reference to a vector of `Vec3f` representing the lines.
 * @param pts A reference to a vector of pairs of `Point` objects where the computed points for each line will be stored.
 */
 ...
 *
 * @param p A constant reference to a `Point` object representing the point to check.
 * @param rows The number of rows in the image (height).
 * @param cols The number of columns in the image (width).
...
/**
 * @brief Computes the angular coefficient (slope) of a given line.
 *
 * This function calculates the angular coefficient (slope) of a line represented by two points.
 ...
 *
 * @param line_1 A constant reference to a pair of `Point` objects representing the first line.
 ...
 * of `Point` objects. The y-intercept is the y-coordinate where the line intersects the y-axis
 * (x = 0).
 *
 * @param line A constant reference to a pair of `Point` objects representing the line.
